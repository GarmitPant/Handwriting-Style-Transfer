...
from data_utils.data_frame import DataFrame
from networks.rnn_cell import LSTMAttentionCell
from networks.rnn_ops import rnn_free_run
from networks.tf_base_model import TFBaseModel
from networks.tf_utils import time_distributed_dense_layer
...
class rnn(TFBaseModel):
    ...
    def calculate_loss(self):
        ...
        cell = LSTMAttentionCell(
            ...
            attention_values=tf.one_hot(self.c, len(data_utils.drawing.alphabet)),
...
if __name__ == '__main__':
    ...
    nn = rnn(
        reader=dr,
        log_dir='logs',
        checkpoint_dir='./checkpoints/handwriting-synthesis',
