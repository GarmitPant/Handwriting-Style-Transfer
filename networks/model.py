...
from data_utils.dataloader_iam import Batch
...
class Model:
    ...
    def setup_cnn(self) -> None:
        ...
        for i in range(num_layers):
            ...
            pool = tf.nn.max_pool(value=relu, ksize=(1, pool_vals[i][0], pool_vals[i][1], 1),
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, './checkpoints/htr/snapshot', global_step=self.snap_ID)
